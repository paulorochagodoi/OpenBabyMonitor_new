...
const FENCE_SETTINGS_NAV_LINK_ID = 'fence_settings_nav_link';
const RECORDING_SETTINGS_NAV_LINK_ID = 'recording_settings_nav_link';
const TIMELINE_NAV_LINK_ID = 'timeline_nav_link';
...
const FENCE_SETTINGS_MODAL_BASE_PROPERTIES = { href: 'fence_settings.php', header: LANG['nav_want_to_leave_site'], confirm: LANG['nav_continue'], dismiss: LANG['cancel'] };
const RECORDING_SETTINGS_MODAL_BASE_PROPERTIES = { href: 'recording_settings.php', header: LANG['nav_want_to_leave_site'], confirm: LANG['nav_continue'], dismiss: LANG['cancel'] };
const TIMELINE_MODAL_BASE_PROPERTIES = { href: 'timeline.php', header: LANG['nav_want_to_leave_site'], confirm: LANG['nav_continue'], dismiss: LANG['cancel'] };
