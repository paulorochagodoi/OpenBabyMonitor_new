  ...
  <div class="d-flex flex-column fillview">
    ...
    <div class="d-flex flex-column flex-grow-1 justify-content-center overflow-auto">
      <main id="main_container" class="fillview" style="display: none;">
        <div class="container">
          <h1 class="my-4"><?php echo LANG['vox_settings']; ?></h1>
          <p class="mb-4" style="max-width: 40rem;"><?php echo LANG['vox_settings_description']; ?></p>
          <form id="vox_settings_form" action="" method="post">
            <div class="row">
              <?php
...
<script>
  const SETTINGS_FORM_ID = 'vox_settings_form';
